...
#===============================================================================
#
#          FILE:  runArtifactory.sh
# 
#         USAGE:  ./runArtifactory.sh 
# 
#   DESCRIPTION:  Artifactory run script to start OSS
# 
#       OPTIONS:  
#  REQUIREMENTS:  Dockerfile for Artifactory
#          BUGS:  ---
#         NOTES:  Currently this script is a copy of the official Artifactory Docker build. I intend on changing it. 
#        AUTHOR:   (Brandon Grantham), 
#       COMPANY:  
#       VERSION:  1.0
#       CREATED:  06/28/2016 09:24:25 PDT
#      REVISION:  0.1
#===============================================================================
